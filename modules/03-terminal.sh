...
# Build & install the one-click "JustVibes" launcher. Prefers /Applications
...
case "$launcher_result" in
  installed)
    log_installed "JustVibes.app installed to $LAUNCHER_DEST"
    ...
    ;;
  *) log_error "Could not install JustVibes. Run this installer again; if it still fails, share this detail with support: $launcher_result" ;;
esac
