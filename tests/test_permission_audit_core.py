...
class PermissionAuditBehaviorTest(unittest.TestCase):
    def test_temporal_correlation_handles_single_multi_and_resumed_sessions(self) -> None:
        ...
        self.assertEqual(by_pattern["/Users/example/code/scripts/lib/common.sh action= substring"]["agents"], ["legolas"])
        self.assertEqual(by_pattern["/Users/example/.config/opencode/opencode.json"]["agents"], ["aragorn"])
    ...
    def test_large_scale_fixture_preserves_permission_agent_attribution(self) -> None:
        ...
        scale_entries = {
            ...
            or entry["pattern"].startswith("/Users/example/.config/opencode/scale-")
        ...
        self.assertEqual(
            {pattern: entry["agents"] for pattern, entry in scale_entries.items()},
            {
                ...
                "/Users/example/.config/opencode/scale-aragorn.json": ["aragorn"],
