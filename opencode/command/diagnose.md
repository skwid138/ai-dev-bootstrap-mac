---
description: >-
  Investigate a reported bug, crash, failing behavior, or performance
  regression without jumping straight to edits. Builds a feedback loop,
  reproduces the issue, tests hypotheses, and hands off a fix plan.
---
